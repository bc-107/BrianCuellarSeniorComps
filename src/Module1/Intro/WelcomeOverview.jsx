        ...
        >
            ...
            <div className="relative z-10 text-center max-w-xl">
                ...
                <p className="text-white md:text-2xl leading-relaxed">
                    Dive into the foundational principles of markets, including supply, demand, and market equilibrium.
                    With interactive simulations and quizzes, you’ll uncover how these dynamics shape real-world economies
                    and businesses. Let’s make learning about markets engaging and fun!
                </p>
